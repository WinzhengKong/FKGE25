...
class Controller:
    ...
    def parse_args(self,args=None):
        ...
        parser.add_argument("--local_file_dir",type=str,default="../Data/FB15k-237/R10FL",help="local file directory, type str, default ../Data/FB15k-237/C3FL")
        parser.add_argument("--save_dir",type=str,default="../Output/FB15k-237/R10FL",help="save dir, type str, default ../Output/FB15k-237/C3FL")
        ...
        parser.add_argument("--byzantine", type=str,default="AddNoise",
        ...
        parser.add_argument("--pentity", type=float, default=0.5,
                            help="pentity for AN, type float, default 0.5")
        parser.add_argument("--noiseweight", type=float, default=1.0,
                            help="noise weight for AN, type float, default 1.0")
        ...
        for iter in range(0,args.max_iter):
            ...
            if iter != args.max_iter-1:
                if args.byzantine == "RandomNoise":
                    ...
                    print('Attack AN!')
                    noise_weight = args.noiseweight
                    min_val, max_val = -0.1, 0.1
                    noise_ratio = args.pentity
                    for idx, byzantine_client_idx in enumerate(byzantine_client_indices):
                        if apply_byzantine_effects[idx]:
                            print(f'Byzantine client id is {byzantine_client_idx}')
                            original_embedding = client_embedding_dict[byzantine_client_idx]
