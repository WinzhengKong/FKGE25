...
class Controller:
    ...
    def parse_args(self,args=None):
        ...
        parser.add_argument("--early_stop_iter",type=int,default=20,help="early stop iter, type int, default 15")
        ...
        parser.add_argument("--byzantine", type=str,default="IDR",
