...
class Controller:
    ...
    def parse_args(self,args=None):
        ...
        parser.add_argument("--client_num",type=int,default=5,help="client num, type int, default 3")
        parser.add_argument("--local_file_dir",type=str,default="../Data/FB15k-237/R5FL",help="local file directory, type str, default ../Data/FB15k-237/C3FL")
        parser.add_argument("--save_dir",type=str,default="../Output/FB15k-237/R5FL",help="save dir, type str, default ../Output/FB15k-237/C3FL")
